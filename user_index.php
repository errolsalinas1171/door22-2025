			...
			<div class="container">
			  <div class="head-top">
               ...
               <center>
               	...
               	<br><br>
					<a href="user_products.php" class="link purple">
						<div class="light"></div>
						<center>
							<table>
								<tr>
									<td>
										<img src="icon/brand-identity.png" width="50px" height="50px">&nbsp;&nbsp;&nbsp;&nbsp;
									</td>
									<td>
										<font color="#252525">Add-on</font>
									</td>
								</tr>
							</table>
						</center>
					...
					<a href="user_payment.php" class="link blue">
						...
						<center>
							<table>
								<tr>
									<td withd="20%">
										<img src="icon/payment-method.png" width="50px" height="50px">&nbsp;&nbsp;
									</td>
									<td>
					...
					<a href="user_account.php" class="link brown">
						<div class="light"></div>
						<center>
							<table>
								<tr>
									<td withd="20%">
										<img src="icon/account-24.png" width="50px" height="50px">&nbsp;&nbsp;
									</td>
									<td>
										<font color="#252525">Account</font>
									</td>
								</tr>
							</table>
						</center>
					</a>
					<a href="logout.php" class="link red">
						<div class="light"></div>
						<center>
							<table>
								<tr>
									<td>
										<img src="icon/cancel_white.png" width="40px" height="40px">&nbsp;&nbsp;&nbsp;&nbsp;
									</td>
									<td>
