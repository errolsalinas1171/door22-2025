		...
		<div class="banner" id="home">
			<div class="container">
			  <div class="head-top">
               ...
               <center>
               	<br><br>
               	<h1><font color="#ffffff">Please Select Payment Method</font></h1>
               	<br><br>
					<a href="mode_payment_type.php?mode=cash" class="link green">
						<div class="light"></div>
						<center>
							<table>
								<tr>
									<td>
										<img src="icon/cash.png" width="50px" height="50px">&nbsp;&nbsp;&nbsp;&nbsp;
									</td>
									<td>
										<font color="#252525">&nbsp;Cash&nbsp;</font>
									</td>
								</tr>
							</table>
						</center>
					</a>
					<a href="mode_payment_type.php?mode=cheque" class="link yellow">
						<div class="light"></div>
						<center>
							<table>
								<tr>
									<td withd="20%">
										<img src="icon/cheque.png" width="50px" height="50px">&nbsp;&nbsp;
									</td>
									<td>
										<font color="#252525">Cheque</font>
									</td>
								</tr>
							</table>
						</center>
