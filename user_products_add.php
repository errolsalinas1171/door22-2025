		...
		<div class="banner" id="home">
			<div class="container">
			  <div class="head-top">
               ...
               <center>
               	<br><br>
               	<h1><font color="#ffffff">Please Select Product</font></h1>
               	<br><br>
       				<?php 
					$sql=mysql_query("SELECT * FROM products WHERE product_status='enabled'");
					while($row=mysql_fetch_array($sql))
					{
					?>
						<a href="user_products_add_qty.php?productID=<?php echo $row['productID']; ?>" class="link" style="background-color: #fff !important; border: 0px solid #000; height: 6.5em;">
							<center>
								<table border="0">
									<tr>
										<td>
											<center>
												<img src="admin/images/products/<?php echo $row['product_img']; ?>" width="70px" height="70px">
											</center>
										</td>
										<td>
											<center>
												...
												<font style="font-family: sans-serif; color: #ff3019; font-size: 13px; font-style: italic; font-weight: 600;">
													Php. <?php echo number_format($row['product_price'],2); ?>
												</font>
											</center>
										</td>
									</tr>
