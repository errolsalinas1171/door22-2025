                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <?php include('displaytodaypayment.php'); ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-red">
                            <div class="panel-body">
                                <img src="icon/cash_red.png" width="100px" height="100px" >
                                <h3>
                                    <?php include('dbconnect.php');
                                    $room_rental=mysql_query("SELECT * from payment WHERE view='no'"); 
                                    $count_rental=mysql_num_rows($room_rental);
                                    echo mysql_num_rows($room_rental);
                                    ?>
                                </h3>
                            </div>
