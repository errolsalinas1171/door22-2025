...
$sql=mysql_query("SELECT users.first_name,users.last_name,users.username,payment.* FROM payment INNER JOIN users ON payment.userID=users.userID ORDER BY payment.paymentID DESC");
