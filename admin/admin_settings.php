            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active">
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="admin_settings_header.php">Header Settings</a> 
                            </li>
                            <li>
                                <a href="admin_settings_receipt_header.php">Receipt Header Settings</a>
                            </li>
                            <li>
                                <a href="admin_settings_receipt_footer.php">Receipt Footer Settings</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <?php include('displayadminaccount.php'); ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <a href="admin_user_display.php">
                    <div class="col-md-3 col-sm-12 col-xs-12">
                        <div class="panel panel-primary text-center no-boder bg-color-green">
                            <div class="panel-body">
                                <img src="icon/account.png" width="100px" height="100px" >
                                <h3>
                                    <?php include('dbconnect.php');
                                    $user=mysql_query("SELECT * from users WHERE user_type='user'"); 
