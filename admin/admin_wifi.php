                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    ...
                                    <div align="right"><a href="admin_wifi_add.php"><button class="btn btn-success">Add WIFI Vouchers</button></a></div>
                                    </div>
                                    <?php include('displaywifi.php'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
