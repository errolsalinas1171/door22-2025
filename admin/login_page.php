...
<!--start-home-->
		...
		<div align="center" class="login">
			<form action="login.php" method="post">
				<input type="text" type="number" min="0" inputmode="numeric" pattern="[0-9]*" title="Non-negative integral number" placeholder="Account Number" name="username"><br>
				<input type="password" type="number" min="0" inputmode="numeric" pattern="[0-9]*" title="Non-negative integral number" placeholder="PIN Number"name="password"><br>
