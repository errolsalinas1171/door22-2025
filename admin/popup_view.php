...
<form action="mode_today.php?paymentID=<?php echo $paymentID; ?>" method="post">
	<table border="0" width="100%">
		<tr>
			...
			<td width="60%">
				<font size="3"><?php echo $row['userID'];?></font>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<font size="3">Envelop #</font>
			</td>
			<td>
				<font size="3"> : </font>
			</td>
			<td width="60%">
				<font size="3"><?php echo $row['envelop_no'];?></font>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			<td>
				<font size="3">Payment Amount</font>
			</td>
			<td>
				<font size="3"> : </font>
			</td>
		...
		<tr>
			...
			<td width="60%">
				<font size="3"><textarea name='note' cols='30' rows='3'></textarea></font>
			</td>
		</tr>
		<tr>
			<td align="right">
				<br><br><input type="submit" name='okay' class="btn btn-primary" value='Okay'>
			</td>
			<td>
				<br><br>
			</td>
			<td width="60%" align="center">
				<br><br>
				<input type="submit" name='not_okay' class="btn btn-primary" value="Not Okay">
			</td>
		</tr>
	</table>
</form>
