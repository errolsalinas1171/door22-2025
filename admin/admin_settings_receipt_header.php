        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li class="active">
                        <a href="#" class="active-menu" ><i class="fa fa-gear"></i></i> Settings<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="admin_settings_header.php">Header Settings</a></li>
                            <li class="active-menu"><a href="admin_settings_receipt_header.php">Receipt Header Settings</a></li>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <?php include('addreceiptheader.php'); ?>
                                </div>
                            </div>
                        </div>
                    </div>
