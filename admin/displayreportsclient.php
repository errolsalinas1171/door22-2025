...
<script>
function myFunction() {
    var myWindow = window.open("reports-client-pdf.php?userID=<?php echo $userID; ?>", "", "width=950, height=800");
}
</script>
...
$sql=mysql_query("SELECT users.*,payment.* FROM payment 
    ...
    WHERE payment.userID='$userID' ORDER BY payment.paymentID DESC");
