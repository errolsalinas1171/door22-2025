		...
		<div class="banner" id="home">
			<div class="container">
			  <div class="head-top">
               ...
               <center>
               	<br><br>
               	<h1><font color="#ffffff">Please add Wifi Voucher quantity</font></h1>
               	<br><br>
               	<form action="transactions.php?mode=wifi" method="POST">
	   				<?php 
       				$voucherDays = $_GET['voucherDays'];
					$sql=mysql_query("SELECT * FROM wifi_vouchers WHERE wifi_voucher_days='$voucherDays' LIMIT 1");
					while($row=mysql_fetch_array($sql))
					{
					?>	
						<textarea hidden name="voucherID"><?php echo $voucherID; ?></textarea>
	       				<tr>
	       					<td align="right">
	       						<font style="font-family: sans-serif; color: #ffffff; font-size: 55px;"><?php echo $row['wifi_voucher']; ?></font><br>
	       						<font style="font-family: sans-serif; color: #ffffff; font-size: 25px;">Php. <?php echo number_format($row['wifi_price'],2); ?></font>
	       						<p>&nbsp;</p>
								<span class="minus">-</span>
								<input type="text" id="input" name="voucherQty" />
					...
					<a href="user_products_wifi_add.php">
