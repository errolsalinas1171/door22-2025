          	...
          	<br>
	         	...
	         	<br>
		            ...
		            ob.value = ob.value.replace(invalidChars,"");
	         			...
	         			<form action="mode_amount.php?mode=amount&&type=<?php echo $type1; ?>" method="POST">
				           	<input type="text" name="envelop_no" placeholder="Envelop Number" required style="width:400px; height:50px; border-radius: 5px;"><br><br>
				           	<input type="text" name="amount" onkeyup="checkInput(this)" required placeholder="Amount" style="width:400px; height:50px; border-radius: 5px;">
				           	<div style="background-color:#011750; width:50%;"> </div><br>
							<table>
				       			<tr>
				       				<td>
										...
										<td>
										<center><a href="user_payment.php"><input type="button" class="link red" value="&nbsp;&nbsp;&nbsp;&nbsp;  BACK  &nbsp;&nbsp;&nbsp;&nbsp;"></center></a>
									</td>
								</tr>
							</table>
						</form>
