...
<!--start-home-->
		<div class="banner" id="home">
          ...
          <?php $type1=$_GET['type']; ?>
          <?php $cheque_number=$_GET['cheque_number']; ?>
          <?php $envelop_no=$_GET['envelop_no']; ?>
          <center>
          	<br>
           	<h1>
           		<font size="5" color="#ffffff">
								Room: 
								Php. <?php echo number_format($room_display['room_price'],2); ?> | 
								Add-ons: 
								Php. <?php 
								$totalPrice =  $prodGrandTotal + $wifiGrandTotal;
           	...
           	<h1>
           		<font size="5" color="#ffffff">
								Total: 
								Php. <?php 
								$GrandtotalPrice = $room_display['room_price'] + $prodGrandTotal + $wifiGrandTotal;
								echo number_format($GrandtotalPrice,2);
								?>
							</font>
						</h1>
	         	<br><br>
	         	<h1><font color="#ffffff">Please Enter Total Amount</font></h1>
	         	<br>
	         	...
	         	<form action="mode_cheque_amount.php?mode=cheque_amount&&type=<?php echo $type1; ?>&&cheque_number=<?php echo $cheque_number; ?>&&envelop_no=<?php echo $envelop_no; ?>" method="POST">
	           	<input type="text" name="cheque_amount" onkeyup="checkInput(this)" placeholder="Amount" style="width:400px; height:50px; border-radius: 5px;">
	         		<div style="background-color:#011750; width:50%;"></div>
							<table>
		       			<tr>
		       				<td>
										<center>
											<input type="submit" class="link green" value="&nbsp;&nbsp;&nbsp;&nbsp;  OKAY  &nbsp;&nbsp;&nbsp;&nbsp;">&nbsp;&nbsp;
										</center>
									</td>
									<td>
										<center>
											<a href="user_payment.php">
													<input type="button" class="link red" value="&nbsp;&nbsp;&nbsp;&nbsp;  BACK  &nbsp;&nbsp;&nbsp;&nbsp;">
											</a>
										</center>
									</td>
								</tr>
