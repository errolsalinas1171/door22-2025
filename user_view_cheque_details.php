...
if($cheque_amount < $totalPrice){
	echo "<script language='Javascript'>
		alert('Amount entered is less than the overall total price.');
		location.href='user_cheque_amount.php?type=".$type1."&&cheque_number=".$cheque_number."&&envelop_no=".$envelop_no."';
		</script>";
		die . mysql_error();
}
		...
		<div class="banner" id="home">
          ...
          <center>
             	...
             	<h1>
		         	...
		         	<h1>
		         		<font size="4" color="#ffffff">
		         			Payment Type : <?php $view_type=$_GET['type']; if ($view_type=='cash'){echo "Cash";} if ($view_type=='cheque'){echo "Cheque";}?>
		         		</font>
		         	</h1>
		         	<h1>
		         		<font size="4" color="#ffffff">
		         			Envelop Number : <?php $view_amount_envelop_no=$_GET['envelop_no']; echo $view_amount_envelop_no; ?>
		         		</font>
		         	</h1>
		         	<h1>
		         		<font size="4" color="#ffffff">
		         			Cheque Number : <?php $view_cheque_number=$_GET['cheque_number']; if ($view_cheque_number==0){echo "0000000000";} else {echo $view_cheque_number;}?>
		         		</font>
		         	</h1>
		         	<h1>
		         		<font size="4" color="#ffffff">Amount : Php. <?php $view_amount=$_GET['cheque_amount']; echo number_format($view_amount,2); ?>
		         	</font>
		         </h1>
		         	<br>
	          </div>
	          <?php $username=$userID['username']; ?>
						...
						<a href="mode_save.php?mode=save_cheque&&transProdID=<?php echo $transProdID; ?>&&transWifiID=<?php echo $transWifiID; ?>&&total=<?php echo $totalPrice; ?>&&cheque_number=<?php echo $view_cheque_number; ?>&&envelop_no=<?php echo $view_amount_envelop_no; ?>&&cheque_amount=<?php echo $view_amount; ?>&&type=<?php echo $view_type; ?>&&fullname=<?php echo $fullname; ?>&&username=<?php echo $username; ?>" class="link green">
							<div class="light"></div>
							<center>
								<table>
									<tr>
