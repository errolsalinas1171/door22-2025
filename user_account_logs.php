			  ...
			  <div class="head-top">
			   <!--logo-->
                ...
                <a href="user_index.php"><h1><font color="#ffffff"><?php echo  $header_display['title'] ?></font></h1></a>
		          ...
		          <center>
		         	<br><br>
		         	<h1><font color="#ffffff">Transaction Logs</font></h1>
		         	<br>
					...
					<font style="color: #ffffff; font-size: 16px;">
						<table border="0" width="80%">
							<tr>
			   				...
			   				<?php 
							$sqlPayment = mysql_query("SELECT * FROM payment WHERE userID='$userID'");
							while($row=mysql_fetch_array($sqlPayment))
							{
							?>
								<tr>
									<td><?php echo $row['paymentID']; ?> </td>
									<td><?php echo $row['envelop_no']; ?></td>
									<td>Php. <?php echo number_format($row['amount'],2);?> </td>
				                    <?php $dateCreated = strtotime($row['date_time']); ?>
				                    <td><span style="font-size: 15px;"><?php echo date("m/d/Y h:i A", $dateCreated);?></span></td>
									<!-- <td>
										<a href=""><button style="padding: 5px; font-size: 14px; margin-bottom: 5px;">View</button></a>
									</td> -->
								</tr>
							<?php } ?>
						</table>
					...
					<a href="user_account.php" class="link red">
						<div class="light"></div>
						<center>
							<table>
								<tr>
