			...
			<div class="container">
			  <div class="head-top">
			   <!--logo-->
                ...
                <center>
               	<br><br>
               	<h1><font color="#ffffff">PIN Settings</font></h1>
               	<br><br>
				          <?php
									$userID=$_GET['userID'];
									...
									{
									echo "<form action='mode_pin_change.php' method='POST'>
				               	<input type='hidden' name='userID' value=".$row['userID'].">
				               	<input type='password' name='password' placeholder='PIN Number' required style='width:400px; height:50px; border-radius: 5px;' value=''><br><br>
												<table>
					               	<tr>
					               		<td>
															<center>
																<input type='submit' class='link green' name='edit' value='&nbsp;&nbsp;&nbsp;&nbsp;  OKAY  &nbsp;&nbsp;&nbsp;&nbsp;'>&nbsp;&nbsp;
															</center>
														</td>
														<td>
